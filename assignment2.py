...
from sklearn.tree import DecisionTreeClassifier  # <-- for a guaranteed fitted tree
...
# Provide a fitted base estimator so it has a `tree_` attribute, guaranteed.
tree_for_check = DecisionTreeClassifier(random_state=42)
tree_for_check.fit(X_imputed, y)
modelFit = tree_for_check
